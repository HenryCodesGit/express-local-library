...
exports.book_create_post = [
    // Convert the genre to an array (if only one is selected because a book can have multiple genres).
    (req, res, next) => {
    ...
    body("genre.*").escape(), //The .* wildcard means each item inside genre array is sanitized
